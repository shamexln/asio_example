 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::medibus::MedibusReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::medibus::MedibusReply>> AsyncDataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::medibus::MedibusReply>>(AsyncDataInEachLoopRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::medibus::MedibusReply>> PrepareAsyncDataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::medibus::MedibusReply>>(PrepareAsyncDataInEachLoopRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      // Request all data for each medibus loop 
      virtual void DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response, std::function<void(::grpc::Status)>) = 0;
      virtual void DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::medibus::MedibusReply>* AsyncDataInEachLoopRaw(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::medibus::MedibusReply>* PrepareAsyncDataInEachLoopRaw(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::medibus::MedibusReply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>> AsyncDataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>>(AsyncDataInEachLoopRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>> PrepareAsyncDataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>>(PrepareAsyncDataInEachLoopRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response, std::function<void(::grpc::Status)>) override;
      void DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>* AsyncDataInEachLoopRaw(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>* PrepareAsyncDataInEachLoopRaw(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // Request all data for each medibus loop 
    virtual ::grpc::Status DataInEachLoop(::grpc::ServerContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response);
  };
  ...
  class WithAsyncMethod_DataInEachLoop : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status DataInEachLoop(::grpc::ServerContext* /*context*/, const ::medibus::LoopRequest* /*request*/, ::medibus::MedibusReply* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestDataInEachLoop(::grpc::ServerContext* context, ::medibus::LoopRequest* request, ::grpc::ServerAsyncResponseWriter< ::medibus::MedibusReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_DataInEachLoop() {
      ::grpc::Service::MarkMethodCallback(13,
          new ::grpc::internal::CallbackUnaryHandler< ::medibus::LoopRequest, ::medibus::MedibusReply>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response) { return this->DataInEachLoop(context, request, response); }));}
    void SetMessageAllocatorFor_DataInEachLoop(
        ::grpc::MessageAllocator< ::medibus::LoopRequest, ::medibus::MedibusReply>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(13);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::medibus::LoopRequest, ::medibus::MedibusReply>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* DataInEachLoop(
      ::grpc::CallbackServerContext* /*context*/, const ::medibus::LoopRequest* /*request*/, ::medibus::MedibusReply* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_CurAlarmsCP3<WithCallbackMethod_CurMeasuredDataCP1<WithCallbackMethod_CurLowAlarmLimitsCP1<WithCallbackMethod_CurHighAlarmLimitsCP1<WithCallbackMethod_CurAlarmsCP1<WithCallbackMethod_CurDeviceSettings<WithCallbackMethod_TextMessages<WithCallbackMethod_CurMeasuredDataCP2<WithCallbackMethod_CurLowAlarmLimitsCP2<WithCallbackMethod_CurHighAlarmLimitsCP2<WithCallbackMethod_CurAlarmsCP2<WithCallbackMethod_DeviceIdentification<WithCallbackMethod_RealTime<WithCallbackMethod_DataInEachLoop<Service > > > > > > > > > > > > > > CallbackService;
  ...
  class WithRawMethod_DataInEachLoop : public BaseClass {
   ...
   public:
    ...
    void RequestDataInEachLoop(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(13, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
   ...
   public:
    WithRawCallbackMethod_DataInEachLoop() {
      ::grpc::Service::MarkMethodRawCallback(13,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->DataInEachLoop(context, request, response); }));
    }
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_DataInEachLoop : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_DataInEachLoop() {
      ::grpc::Service::MarkMethodStreamed(13,
        new ::grpc::internal::StreamedUnaryHandler<
          ::medibus::LoopRequest, ::medibus::MedibusReply>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::medibus::LoopRequest, ::medibus::MedibusReply>* streamer) {
                       return this->StreamedDataInEachLoop(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_DataInEachLoop() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status DataInEachLoop(::grpc::ServerContext* /*context*/, const ::medibus::LoopRequest* /*request*/, ::medibus::MedibusReply* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedDataInEachLoop(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::medibus::LoopRequest,::medibus::MedibusReply>* server_unary_streamer) = 0;
  };
