...
Medibus::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_DataInEachLoop_(Medibus_method_names[13], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Medibus::Stub::DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::medibus::MedibusReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::medibus::LoopRequest, ::medibus::MedibusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_DataInEachLoop_, context, request, response);
}

void Medibus::Stub::async::DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::medibus::LoopRequest, ::medibus::MedibusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DataInEachLoop_, context, request, response, std::move(f));
}

void Medibus::Stub::async::DataInEachLoop(::grpc::ClientContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DataInEachLoop_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>* Medibus::Stub::PrepareAsyncDataInEachLoopRaw(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::medibus::MedibusReply, ::medibus::LoopRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_DataInEachLoop_, context, request);
}

::grpc::ClientAsyncResponseReader< ::medibus::MedibusReply>* Medibus::Stub::AsyncDataInEachLoopRaw(::grpc::ClientContext* context, const ::medibus::LoopRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncDataInEachLoopRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
Medibus::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Medibus::Service, ::medibus::LoopRequest, ::medibus::MedibusReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Medibus::Service* service,
             ::grpc::ServerContext* ctx,
             const ::medibus::LoopRequest* req,
             ::medibus::MedibusReply* resp) {
               return service->DataInEachLoop(ctx, req, resp);
             }, this)));
}
...
::grpc::Status Medibus::Service::DataInEachLoop(::grpc::ServerContext* context, const ::medibus::LoopRequest* request, ::medibus::MedibusReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
